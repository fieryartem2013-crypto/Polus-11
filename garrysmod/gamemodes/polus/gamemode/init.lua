...
local sv = {
    ...
    "modules/p11_sv_craft.lua",       -- v4.10.0 «ГАРАЖ»: кустарная мастерская (крафт, 6 рецептов)
    "modules/p11_sv_donate2.lua",     -- v4.10.0 «ГАРАЖ»: донат-валюта «ПОЛЮС-ФЛЮКС» + витрина + утилиты выдачи
    "modules/p11_sv_thingkit.lua",    -- v4.10.0 «ГАРАЖ»: НЕЧТО «ЛИЧИНА 3.0» — ВСЕГДА ПОСЛЕДНИЙ (подменяет ядра маскировки/поглощения)
}
