...
local send = {
    ...
    "modules/p11_cl_sbor.lua",        -- v4.34.0 «СБОР»: экстренный сбор — баннер причины + маркер места
...
local sv = {
    ...
    "modules/p11_sv_sbor.lua",        -- v4.34.0 «СБОР»: экстренный сбор (/сбор <причина> — место, перекличка)
