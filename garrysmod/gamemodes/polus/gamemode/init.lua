...
local send = {
    ...
    "modules/p11_cl_dispatch.lua",    -- v4.19.0 «ГЛАЗ»: пульт диспетчера — камеры/3-е лицо/выдача/двери
}
...
local sv = {
    ...
    "modules/p11_sv_dispatch.lua",   -- v4.19.0 «ГЛАЗ»: диспетчер «Красного Орла» — сеансы/выдача/двери (сервер)
