...
local HELP = {
    ...
    { h = "КЛАВИШИ", t = "F1 — эта справка • F4 — должности • TAB — состав станции • Q — строительство (пропы-«призраки», E — взять/поставить) • /р + текст в чате — рация • !работа — меню должностей • E по своему пропу — нести • !репорт — написать админам • !ролл — кубик 1-100." },
