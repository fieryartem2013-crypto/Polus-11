-- ============================================================
--  ПОЛЮС-11 — ПЕРЕОХЛАЖДЕНИЕ (server) v3.8 (v4.5.0: в транспорте тепло)
    ...
    for _, ply in ipairs(player.GetAll()) do
        if IsValid(ply) and ply:Alive() then
            ...
            if thing then
                ...
                -- v4.5.0: В ТРАНСПОРТЕ не замерзает — грузовик колонны с печкой.
                -- Пока едешь/сидишь в кабине LVS (или любом транспорте) — тепло.
