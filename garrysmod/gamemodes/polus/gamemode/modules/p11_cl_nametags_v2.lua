-- ============================================================
--  ПОЛЮС-11 — таблички с именами (client) → v5.2.3 КОПИЯ-Новый файл
--  Отличия от оригинала: дежурство ВЫШЕ ника, медали НИЖЕ ранга v4.4.0 «ОРДЕН» (v4.27.0)
            ...
            if dist < 450 * 450 then
                ...
                if not tr2.Hit or tr2.Entity == ply then
                    ...
                    if pos.visible then
                        ...
                        -- v5.2.3 «ДЕЖУРСТВО»: плашка поста НАД ГОЛОВОЙ, выше ника
                        ...
                        -- v4.27.0 «ОРДЕН» → v5.2.3: НАГРАДНАЯ ПЛАНКА ПОД РАНГОМ —
                        -- порядок сверху вниз: дежурство · имя · должность · ранг · МЕДАЛИ
