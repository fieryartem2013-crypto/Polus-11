...
--  на карте случайно встают 3 точки прорыва (энтити «ФЛАГ» —
--  те же правила: толпа жмёт быстрее, враг в круге — стоп).
...
local POINTS_N = 3             -- точек прорыва
...
print("[POLUS-11] РЕЙДЫ v4.24.0 «РУБЕЖ»: терминал рейда · только командиры · 3 точки прорыва · " ..
