-- ============================================================
--  ПОЛЮС-11 — ЧАТ (server) v7.1 «ФИЛЬТР+ЭФИР» → v5.2.3 КОПИЯ-Новый файл
--  Единственное отличие от оригинала: +!снятьдежурство в белом списке
...
local BANG_SERVER = {
    ...
    ["!снятьдежурство"] = true, ["!снятьпост"] = true, -- p11_sv_duty v5.2.3 «ДЕЖУРСТВО»
}
local BANG_CLIENT = {
