...
POLUS11.Items = {
    ...
    -- v5.2.0 «БИТВА ВРЕМЕНИ»: СЕКРЕТНЫЙ АРСЕНАЛ РЕЙХА (трофеи Осовца/Вермахта —
    -- РККА не смогло утащить; классы ARC9 EFT, фолбэк на сток без пака)
    stg44    = { name = "StG-44 «Штурмгевер»",  price = 15000, class = "arc9_eft_stg44",       desc = "Секретный штурмовой карабин рейха. Трофей Крепости Осовец." },
    mp40     = { name = "MP-40 «Машиненпистоле»",price = 9000,  class = "arc9_eft_mp40",        desc = "Секретный пистолет-пулемёт Вермахта. Трофей Крепости Осовец." },
    g43      = { name = "Gewehr 43",             price = 11000, class = "arc9_eft_g43",         desc = "Самозарядная винтовка рейха. Трофей Крепости Осовец." },
    p08      = { name = "Luger P08 «Парабеллум»",price = 4500,  class = "arc9_eft_p08",         desc = "Легендарный пистолет офицеров рейха. Трофей Крепости Осовец." },
    -- v5.2.1: ещё трофеи рейха/арсенал EFT для батл-пасса
    ak74m    = { name = "АК-74М",                  price = 14000, class = "arc9_eft_ak74m",       desc = "Модернизированный автомат. Трофей арсенала." },
    svd      = { name = "СВД «Драгунова»",         price = 16000, class = "arc9_eft_svd",         desc = "Снайперская винтовка. Трофей арсенала." },
    rpk16    = { name = "РПК-16",                  price = 18000, class = "arc9_eft_rpk16",       desc = "Ручной пулемёт нового поколения. Трофей арсенала." },
    -- ---- станционный скарб ----
