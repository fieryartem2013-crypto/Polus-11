...
--     мимолётный СИЛУЭТ на периферии. Зацикленный стук сердца (<25) ВЫРЕЗАН v4.22.2 «ТИШИНА».
...
-- ============ СТУК СЕРДЦА (<25) — ВЫРЕЗАН v4.22.2 «ТИШИНА» ============
-- Заявка владельца: «убери старый звук при низком рассудке — как будто
-- что-то бьёт меня, а то уши умерли от его вечного повторения».
-- Зацикленного молотка по ушам больше НЕТ; о грани предупреждает
-- разовая серверная весть «ТЫ НА ГРАНИ» со стоном (при пересечении <25).

print("[POLUS-11] рассудок (client) v4.22.2 «ТИШИНА»: индикатор, виньетка, ложные звуки, фантом; стук сердца ВЫРЕЗАН (заявка владельца)")
