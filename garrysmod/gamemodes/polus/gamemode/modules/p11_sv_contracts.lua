...
--     штатным событиям станции (TaskEvent: патруль/крафт/кровь/
...
POLUS11.ContractPool = {
    ...
    patrul  = { name = "ОБХОД ПЕРИМЕТРА",         desc = "Досмотри 4 патрульных поста (E и держи 3 сек на посту)",         ev = "patrol_point", need = 4, pay = 3000 },
