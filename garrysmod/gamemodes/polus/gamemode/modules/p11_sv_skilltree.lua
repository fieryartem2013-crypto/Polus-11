...
--     TaskEvent (та же труба, что задачи/контракты/ЛЕДОКОЛ):
--     закрытый наряд +50, сдача улики +30, груз снабжения +30,
--     анализ крови/арест +25, лечение/взятие должности +20,
--     крафт/калибровка/ТО/приказ +15, кухня/уборка/взятие
    ...
    science = {
        ...
        paths = {
            ...
            pole = { name = "ПОЛЕВОЙ ПРОТОКОЛ", nodes = {
                { id = "sc_p1", perk = { name = "Полевой протокол", desc = "+25% к опыту службы за научные дела (анализы, калибровки, ТО аппаратуры)" }, lvl = 2 },
...
local SCIENCE_KEYS = { blood_test = true, calibrate = true, gen_service = true }
