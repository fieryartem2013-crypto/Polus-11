...
local SEED_JOBS = {
    ...
    -- v4.19.0 «ГЛАЗ» (заявка владельца «система диспетчера: профа
    -- диспетчер Красных орлов… энтити — его терминал»): ГЛАЗА И УШИ
    -- резидентуры. Работает через энтити-терминал polus11_dspterm
    -- (📍 роль dspterm) и сеть камер polus11_seccam (роль cam):
    -- модуль p11_sv/p11_cl_dispatch — вид с камер, наблюдение за
    -- любым бойцом ОТ 3-ГО ЛИЦА, выдача ХП/брони/стволов EFT,
    -- маяк цели орлам, сигнал в эфир, блок/открытие дверей карты.
    {
        id = "seed_eagle_dispatcher", time = 300, category = "eagle", order = 65, whitelist = true,
        name = "Диспетчер «Красного Орла»",
        desc = "Глаза и уши резидентуры (v4.19.0 «ГЛАЗ»): сидит за терминалом «ГЛАЗ» — смотрит сеть камер станции, переключается на поле зрения любого человека и смотрит за ним ОТ ТРЕТЬЕГО ЛИЦА. Поддержка агентов с пульта: +25 ХП / +50 брони / стволы арсенала Центра (MP5A3, UMP-45, M4A1, M1A, SA-58, M700, Rem 870 — из пака EFT), 📍 маяк цели на 60 сек для всех орлов, 📡 сигнал в эфир фракции, дистанционный БЛОК и открытие любой двери станции. Кейс «ЛЕГАТ» и рация в снаряге, M1911A1 под пульт. 100 ХП / 50 брони. Одно место.",
        weapons = { "weapon_polus11_disguise", { "arc9_eft_m1911a1", "weapon_pistol" }, "weapon_polus11_radio" },
        hp = 100, armor = 50, max = 1,
        color = Color(115, 150, 215),
        models = {
            "models/hts/comradebear/pm0v3/player/usarmy/infantry/co/m41_s1_01.mdl",
            "models/hts/comradebear/pm0v3/player/usarmy/infantry/co/m41_s1_02.mdl",
            "models/hts/comradebear/pm0v3/player/usarmy/infantry/co/m41_s1_04.mdl",
