...
function P11.OpenPlaceMenu()
    ...
    local roles = {
        ...
        { id = "cam",        name = "📷 Камера «ГЛАЗ»",          desc = "сеть диспетчера: куда повёрнута — туда и смотрит (v4.19.0)" },
        { id = "dspterm",    name = "🖥 Терминал диспетчера",    desc = "пульт «ГЛАЗ»: камеры/3-е лицо/выдача/двери (v4.19.0)" },
    }
