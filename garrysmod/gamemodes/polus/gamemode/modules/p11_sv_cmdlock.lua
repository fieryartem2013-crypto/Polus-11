...
local PUBLIC = {
    ...
    ["p11_thingleave"] = true, -- v4.14.2 «КАЗНА»: дверь выхода — изгнать паразита из СЕБЯ — игрокам разрешено
    ["p11_thingevent"] = true, -- v4.18.2 «ВЕРБОВКА»: ивент Нечто сам ставит АДМИН (внутренний гейт ранг 4+, перебивки не будет)
    ["p11_offer"] = true,      -- v4.18.2 «ВЕРБОВКА»: старый тумблер вакансии — туда же (внутри Admin 4+)
    ["p11_offerdiag"] = true,  -- v4.18.2 «ВЕРБОВКА»: диагностика вакансии — внутри Admin 4+
    ["p11_dspxit"] = true,     -- v4.19.2 «ШЛЮЗ»: дверь выхода из пульта диспетчера — игрокам разрешено (свой сеанс)
}
