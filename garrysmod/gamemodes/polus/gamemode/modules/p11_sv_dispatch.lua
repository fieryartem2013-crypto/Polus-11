...
function POLUS11.DispatchUse(ply, term)
    ...
    if POLUS11.Notify then
        POLUS11.Notify(ply, "Сеанс «ГЛАЗА» открыт: A/D — переключение • SPACE — камеры/люди • цифры 1–9 — действия • G — бинокль • СРЕДНЯЯ КНОПКА МЫШИ — курсор/пульт дверей • E/ESC — выход.") -- v4.20.2 «БРОНЯ»: полная шпаргалка, меню за средней кнопкой
    end
    if P11FW and P11FW.Log then
...
print("[POLUS-11] «ГЛАЗ»: диспетчер-камеры Красных Орлов v4.20.2 «БРОНЯ»")
