...
POLUS_BUILD = "4.7.0" -- версия сборки (v4.7.0 «РЕЛЕ»: чат пересоздан — двойная дорога «лента + движковое зеркало», авто-лечение при любой ошибке, рукопожатие клиент↔сервер, режим p11_chat_mode 0/1; фикс: /ларёк /обмен /деньги больше не ловятся чатом)
