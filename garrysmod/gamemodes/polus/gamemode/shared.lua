...
POLUS_BUILD = "4.3.0" -- версия сборки (v4.3.0 «ДЕЛО БОЙЦА»: персонаж при входе — позывной+описание, сохраняются; взгляд — серверный ник и плавное описание; !дать деньги Главе; Нечто крадёт и описание)
