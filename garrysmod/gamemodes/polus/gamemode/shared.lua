...
POLUS_BUILD = "4.6.1" -- версия сборки (v4.6.1 «СПАВНЫ»: вкладка СПАВНЫ в /menu — разные точки появления для каждой ФРАКЦИИ и каждой ПРОФЫ (приоритет: профа > фракция > общий спавн > карта), список расставленного; консоль p11_arrival job/unjob/list; рядом экран вербовки v4.6.0)
