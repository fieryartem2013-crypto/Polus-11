...
POLUS_BUILD = "4.6.2" -- версия сборки (v4.6.2 «МАСШТАБ»: C-меню и весь фирменный UI крупнее — текст больше не налезает; браузер моделей — окно больше, тайлы крупнее, открывается сразу ВЕСЬ каталог форм; новая профа «Начальник Комплекса» в ПЕРСОНАЛЕ (🔒 вайтлист, 1 место, золотой))
