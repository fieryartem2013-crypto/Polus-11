...
POLUS_BUILD = "4.4.0" -- версия сборки (v4.4.0 «ВАЙТЛИСТ»: допуски должностей + ранги Faction Officer/Leader; C-меню и браузер моделей переписаны с нуля; вкладки АДМИНКИ и ВАЙТЛИСТ в /menu; кадровик удаляется навсегда; всё НКВД под вайтлистом)
