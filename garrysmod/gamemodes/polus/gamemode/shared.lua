-- ============================================================
--  POLUS-11 RP — ГЕЙММОД (shared) — сборка 3.8.2 (ЗАТ, hotfix)
...
--  авто-сид пресетов РККА/Наука/Нечто).
...
POLUS_BUILD = "3.8.2" -- версия сборки-гейммода (hotfix: vitals curWarm, холод, ранги, сид РККА)
