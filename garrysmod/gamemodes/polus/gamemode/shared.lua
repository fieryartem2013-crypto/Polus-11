...
POLUS_BUILD = "4.2.2" -- версия сборки (v4.2.2: деньги ВЫШЕ худ жизни — «золотой кошелёк», глянец панелей, интро v3 «полярное сияние» + кнопка ПРОПУСТИТЬ, пропуск обучения удержанием N)
