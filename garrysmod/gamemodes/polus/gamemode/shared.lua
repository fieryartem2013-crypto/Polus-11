...
POLUS_BUILD = "4.6.8" -- версия сборки (v4.6.8 «ГОЛОС»: чат ПОЛНОСТЬЮ ПЕРЕПИСАН с нуля — сервер+клиент чистые, самопроверка при загрузке ([P11CHAT] v4.6.8 OK), HUDPaint под бронёй, диагностика p11_chatdiag / p11_chatdiag_cl, аварийный p11_vanilla_chat 1)
