...
POLUS_BUILD = "4.8.3" -- версия сборки (v4.8.3 «ПОГЛОЩЕНИЕ»: реворк Нечто — убийство когтями само жрёт труп и надевает личину, R — меню мутаций (тиры, личина, формы кнопками), ПКМ — способность формы; починена выдача админ-рангов (p11_rank пропускал никого), ТАБЕЛЬ О РАНГАХ в C-меню с шпаргалкой прав по рангам, досье НКВД открывается по /досье, химсвет гаснет зримо (60 сек угасания, полка 14 на карте))
