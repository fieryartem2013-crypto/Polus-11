...
POLUS_BUILD = "4.8.1" -- версия сборки (v4.8.1 «ЭФИР»: 3D-голос с затуханием по дистанции, местная речь по радиусу из конфига (/шепот /крик), рация починена и выдана всем военным РККА/НКВД, канал по умолчанию «Общий» + команда /канал без R, особая вакансия Нечто у кадровика стала зримой — красный маркер над NPC и баннер)
