...
POLUS_BUILD = "4.7.2" -- версия сборки (v4.7.2 «ФИЛЬТР»: чат с полной подсветкой — трейс каждого сообщения в консоль сервера/клиента, диагностика видит ВСЕ хуки чата (чужие аддоны сразу видно), аварийный p11_chat_passthrough 1 = чистый движок)
