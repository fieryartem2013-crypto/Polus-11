...
POLUS_BUILD = "4.6.5" -- версия сборки (v4.6.5 «ЧИСТЫЙ ВХОД»: ник и время игры ДОБИТЫ — SteamID64-ключи JSON-To-Table ломал, переехали на STEAM_0-ключи; экран вербовки ВЫРЕЗАН полностью (!смена открывает F4); чат — пульт диагностики p11_chatdiag / p11_chatdiag_cl и аварийный выход p11_vanilla_chat 1; анкета ещё терпеливее после интро)
