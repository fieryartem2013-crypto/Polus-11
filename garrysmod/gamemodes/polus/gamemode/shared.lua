...
POLUS_BUILD = "4.2.3" -- версия сборки (v4.2.3 FIX-ПАК: кадровик — стойка переприменяется, нет T-pose; p11_npcmodel живая смена модели; укол ПКМ гуманный; труп R с 2.2 м; единый UI P11UI; устаревшие формы скрыты)
