...
POLUS_BUILD = "4.6.3" -- версия сборки (v4.6.3 «ШТИЛЬ»: МАГНИТНАЯ БУРЯ УБРАНА (AUTOSTORM=false); ЧАТ АРМИРОВАН — ошибка обработчика не съест речь (xpcall + OnPlayerChat-страховка в ленту); виджет задач — честная сетка строк, ничего не налезает; терминал УЖЕСТОЧЁН — обход для админов выключается TerminalAdminBypass; рубли/чат — предохранители от наложения на панель жизни)
