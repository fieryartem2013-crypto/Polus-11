...
POLUS_BUILD = "4.5.0" -- версия сборки (v4.5.0 «ПРИБЫТИЕ»: свой чат-UI с каналами /ooc /looc /me /it /report; зона прибытия по фракциям + LVS-грузовик, в транспорте тепло; время игры открывает профы (SuperAdmin+ без лимита), Глава обходит все вайтлисты; НКВД красно-чёрное; ранги выдают Куратор+; вечный РП-ник и /name)
