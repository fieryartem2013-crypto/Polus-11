...
POLUS_BUILD = "4.6.6" -- версия сборки (v4.6.6 «СЛУЖБА»: ЛЕСТНИЦА ВРЕМЕНИ на все профы (30→300 мин, SuperAdmin+ без лимита, оповещение «⏳ открылась должность», ⏱ минуты в TAB); все лимитки 1 → 2 места: Нечто, комиссар, генералы, особист, нач. НКВД, менеджер, создатель, Начальник Комплекса; миграция 0.7 сама дотащит старые сейвы)
