...
POLUS_BUILD = "4.6.7" -- версия сборки (v4.6.7 «ПОД ЗАМКОМ»: вайтлист-профы (НКВД и др.) теперь ПОЛНОСТЬЮ СКРЫТЫ из F4 у игроков без допуска — HideWhitelistJobs=true в fw_sh_config.lua; админы и Глава видят всё)
