...
POLUS_BUILD = "4.7.1" -- версия сборки (v4.7.1 «СТОК»: чат урезан до нуля кастома — ввод/показ ТОЛЬКО штатным движком, сервер лишь роутит каналы+радиусы и цветит строки через обычный chat.AddText; нечему ломаться)
