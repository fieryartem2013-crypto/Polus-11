...
POLUS_BUILD = "4.7.3" -- версия сборки (v4.7.3 «ТОЧКА СБОРА»: спавны исправлены — единый резолвер профа > фракция > общая > карта, общий спавн не драчуется с точками фракций, телепорт на новую точку СРАЗУ при смене должности, арестованных не трогаем, диагностика p11_spawndiag)
