...
POLUS_BUILD = "4.2.3" -- версия сборки (v4.2.3: C-меню неубиваемое — сторож KEY_C + p11_cmenu + !меню; кошелёк над HUD; интро v3 «полярное сияние» + кнопка ПРОПУСТИТЬ; пропуск обучения N)
