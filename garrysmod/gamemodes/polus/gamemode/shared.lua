...
POLUS_BUILD = "4.6.0" -- версия сборки (v4.6.0 «ВЕРБОВКА»: полноэкранный выбор ФРАКЦИИ и ПРОФЕССИИ при спавне — открывается сам после анкеты/заставки, также !смена / !выбор / !вербовка / p11_spawnmenu; все гейты сохранены: 🔒 вайтлист, ⏳ время, места; занял должность — разморожен и спавнится в зоне прибытия своей фракции)
