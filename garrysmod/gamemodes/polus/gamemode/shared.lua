...
POLUS_BUILD = "4.6.9" -- версия сборки (v4.6.9 «ОБМЕННЫЙ ПУНКТ»: починен выбор должности во вкладке ВАЙТЛИСТ (выбор «липкий») + допуски-SteamID64 конвертируются в STEAM (не теряются после рестарта); ларёк — три пути открытия (E / C-меню / /ларёк) + p11_shopdiag; НОВИНКИ: обмен игрок↔игрок 🤝 (предметы+рубли, двойное «ГОТОВ») и оклад службы каждые 7 мин)
