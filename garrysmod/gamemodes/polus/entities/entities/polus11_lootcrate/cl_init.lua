...
-- Ящик лома: табличка над полным ящиком, над пустым — время пополнения.
...
function ENT:Draw()
    ...
    cam.Start3D2D(top, ang, 0.09)
        draw.SimpleTextOutlined("ЯЩИК ЛОМА", "P11FW.NPC.Big", 0, 0,
            Color(235, 210, 140, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 220))
        if ready then
