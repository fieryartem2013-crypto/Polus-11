...
-- ============================================================
--  ГАРАЖ-МАСТЕР «ПОЛЮС-АВТО» — клиент (v4.10.0 «ГАРАЖ»)
...
function ENT:Draw()
    ...
    cam.Start3D2D(pos, ang, 0.09)
        draw.SimpleTextOutlined("🚗 ГАРАЖ «ПОЛЮС-АВТО»", "P11.Garage.Big", 0, 0,
            Color(255, 190, 90, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 220))
        draw.SimpleTextOutlined("[ E ] — купить транспорт (грузовики, броневик, самолёт)", "P11.Garage.Small", 0, 42,
