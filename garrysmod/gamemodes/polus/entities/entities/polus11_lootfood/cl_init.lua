...
-- Продовольственный ящик: табличка + таймер пополнения.
...
function ENT:Draw()
    ...
    cam.Start3D2D(top, ang, 0.09)
        draw.SimpleTextOutlined("ПРОДОВОЛЬСТВЕННЫЙ ЯЩИК", "P11FW.NPC.Big", 0, 0,
            Color(235, 215, 140, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 220))
        if ready then
