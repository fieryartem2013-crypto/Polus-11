...
-- Топливная бочка: табличка, у пустой — обратный отсчёт.
...
function ENT:Draw()
    ...
    cam.Start3D2D(top, ang, 0.09)
        draw.SimpleTextOutlined("ТОПЛИВНАЯ БОЧКА", "P11FW.NPC.Big", 0, 0,
            Color(255, 190, 100, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0, 220))
        if ready then
            draw.SimpleTextOutlined("[ E ] — слить остатки", "P11FW.NPC.Small", 0, 46,
