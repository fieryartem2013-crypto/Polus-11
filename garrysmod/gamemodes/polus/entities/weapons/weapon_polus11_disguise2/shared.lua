...
--  медик, стоковые модели HL2) и работает МГНОВЕННО, без меню:
--  щелчок — авто-легенда (позывной/документ липовые сами),
--  повторный — маска сорвана. Сервер: p11_sv_disguise.lua, op 6.
-- ============================================================
