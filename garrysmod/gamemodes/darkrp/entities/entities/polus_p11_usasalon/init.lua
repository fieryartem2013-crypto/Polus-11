...
-- ============================================================
--  ТРАНСПОРТНИК «ЯНКИ-АВТО» (США) — сервер (v4.31.0 «КРЫЛО»)
--  Клон гараж-мастера для американской стороны: каталог/покупка —
--  в p11_sv_garage (DealerSide usa, плейсхолдеры LVS до списка владельца).
--  Кузов паттерна: VPHYSICS + самолечение BBOX + тройная страховка анимации.
...
function ENT:Use(activator)
    ...
    if POLUS11.OpenGarageUI then
        ...
        activator:ChatPrint("[ЯНКИ-АВТО] Гаражный модуль не проснулся — смотри [POLUS][ERROR] в консоли сервера.")
    end
end
