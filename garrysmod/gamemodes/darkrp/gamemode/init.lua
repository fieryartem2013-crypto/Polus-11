...
local send = {
    ...
    "modules/p11_cl_battlepass.lua",   -- v5.2.0 «БИТВА ВРЕМЕНИ»: батл-пасс — меню F5, 20 уровней, награды
...
local sv = {
    ...
    "modules/p11_sv_battlepass.lua",  -- v5.2.0 «БИТВА ВРЕМЕНИ»: батл-пасс — XP за дела, 20 уровней, награды (ПОСЛЕ всех обёрток TaskEvent!)
    ...
    -- v5.8.29 «СБОР-2»: старый файл НЕ грузился вообще — в concommand было
    -- `function(ply)` + `{...}` (вне vararg-функции = ошибка компиляции Lua 5.1).
    -- Правило 2: правим только список загрузки, старый файл остаётся на диске.
    -- "modules/p11_sv_sbor.lua",
    "modules/p11_sv_sbor_v2.lua",     -- v5.8.29: экстренный сбор (/сбор <причина>, перекличка)
