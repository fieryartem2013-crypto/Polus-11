...
function PANEL:Paint(w, h)
    ...
    draw.SimpleText("💼 КЕЙС МАСКИРОВКИ «ЛЕГАТ»", "P11.DsgTitle", 16, 6,
        Color(255, 205, 110))
    -- v5.8.14: заголовок-подпись разбит на 2 строки — слово «Орёл» не обрезается
    draw.SimpleText("отряд «Красный Орёл» · собственность ЦРУ",
        "P11.DsgSm", 16, 30, Color(120, 128, 150))
    draw.SimpleText("не открывать при враге",
        "P11.DsgSm", 16, 46, Color(120, 128, 150))
