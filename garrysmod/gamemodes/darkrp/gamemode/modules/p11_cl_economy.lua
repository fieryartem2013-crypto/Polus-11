...
local function EcoFrame(title, w, h)
    ...
    f.Paint = function(s, ww, hh)
        ...
        draw.RoundedBoxEx(10, 0, 0, ww, 3, Color(205, 60, 52, 235), true, true, false, false) -- v5.0.0: красное знамя
...
function P11.OpenPlaceMenu()
    ...
    local roles = {
        ...
        { id = "usasalon",   name = "🦅 Транспортник США", desc = "«ЯНКИ-АВТО»: лавка стороны США, плейсхолдеры LVS (v4.31.0)" },
        ...
        { id = "food",       name = "🥫 Прод. ящик",           desc = "лут: тушёнка/паёк/спирт (v4.15.0)" },
        ...
        { id = "jailnpc",    name = "🗝 Начальник караула",      desc = "принимает задержанных: камера 3/5/10 мин (v4.22.0)" },
        { id = "stashnpc",   name = "💜 Связной (кладмен)",       desc = "закладка 1000₽ → случайная точка → миниигра → +2200₽ (v4.24.0)" },
        { id = "raidterm",   name = "⚔ Терминал рейда",           desc = "командир объявляет рейд: 3 точки прорыва, бой 10 мин (v4.24.0)" },
    }
