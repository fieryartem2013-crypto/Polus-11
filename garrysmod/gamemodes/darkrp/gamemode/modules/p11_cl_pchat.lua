...
function CH.Build()
    ...
    -- v4.19.1 «ЛЕНТА» (заявка «чат очень широкий, а сообщения в столбик
    -- криво — сделай нормально»): перенос считай под РЕАЛЬНУЮ ширину
    -- окна — раньше logW тут занулялся, и RebuildRows мял всё по 160px.
    CH.logW = W
    local px, py = ChatPos()
