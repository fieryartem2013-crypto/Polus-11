...
--    { [jobId] = { ["STEAM_0:x:y"]=true } }
--  v4.6.9: ключи ТОЛЬКО в STEAM-формате — серверный модуль сам
--  конвертирует принятые SteamID64 (длинные числовые ключи движок
--  портит при чтении JSON, допуски терялись после рестарта).
-- ============================================================
