...
P11FW.Config = {
    ...
    -- v4.8.0: Q-МЕНЮ (спавнменю) — с какого ранга открывается.
    -- По заявке владельца: Developer (9) и выше — да, все ниже — нет.
    -- Проверка через P11FW.CanDevMenu(ply). Поставь 0, чтобы вернуть
    -- Q-меню всем, как было до v4.8.0.
    DevMenuLevel = 9, -- Developer+
