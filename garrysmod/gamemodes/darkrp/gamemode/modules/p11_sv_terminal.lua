...
POLUS11.XTaskCatalog = {
    -- v4.12.0 «ОТБОЙ»: генераторных поручений больше нет (энергосистема выведена) —
    -- вместо них живая работа: обыск лутниц и сборка на верстаке.
    { key = "loot_find",   name = "Обыскать лутницы станции (×2)",     max = 2 },
    { key = "craft_do",    name = "Собрать изделие на верстаке",       max = 1 },
    { key = "haul",        name = "Перетащить груз (бочка на плече)",  max = 1 },
    ...
    { key = "alive",       name = "Вахта: 6 минут в живых",           max = 360 }, -- v4.19.5 «ДОПРОС»: слово «патруль» вырезано из игры
