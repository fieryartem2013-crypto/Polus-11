...
--     Верх командования (Стафф-Лидер 14 / Чиф-Стафф 15 / Глава 16) в
--     наручники не берём; остальной стафф — МОЖНО (v4.31.0 «КРЫЛО», заявка
--     владельца «вязать можно всех, кроме Главы проекта, также Стафф-Лидера»).
-- ============================================================
...
function POLUS11.CuffTry(captor, target)
    ...
    if P11FW.GetRankLevel and P11FW.GetRankLevel(target) >= 14 then -- v4.31.0 «КРЫЛО»: верх не вяжем (был ранг 3+)
        POLUS11.Notify(captor, "Стафф-Лидера и Главу проекта в наручники не берём — они вне конвоя.")
        return
    end
